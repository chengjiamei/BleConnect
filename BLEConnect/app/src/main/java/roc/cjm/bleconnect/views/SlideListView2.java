...
public class SlideListView2 extends ListView {
    ...
    private OnItemClickListener onTpItemClickListener;
    ...
    public SlideListView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public SlideListView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
            ...
            case MotionEvent.ACTION_UP:
                if (mFocusView != null) {
                    if (hasConsume) {
                        ...
                        onTpItemClickListener = getOnItemClickListener();
                                ...
                                mFocusView.setOnSlideViewListener(new SlideView2.OnSlideViewListener() {
                                    ...
                                    public void onSlideStateChanged(int state) {
                                        ...
                                        if(onTpItemClickListener != null) {
                                            setOnItemClickListener(onTpItemClickListener);
                                        }
                                    }
                                });
